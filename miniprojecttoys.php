...
<header class="header">
    ...
    <div class="d-flex flex-column" >
        ...
        <div class="profile">
          <img class="toy_img" src="https://www.chemicalsafetyfacts.org/wp-content/uploads/shutterstock_383521510-002-scaled.jpg" alt="toys" class="img-fluid rounded-circle">
          <h1 style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; color: #900C3F; font-size: 30px; margin-left: 20%;"><u><b>Baby Toys</b></u></h1>
...
<b>Toys and Games</b>      </button>    
    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body"><button class="toyscategories">Action Toys</button>
      <button class="toyscategories">Sports Toys</button>
      <button class="toyscategories">Musical Toys</button>
      <button class="toyscategories">Outdoor Toys</button>
    </div>
    </div>
  </div>  
</div>  
...
<div class="container">
    <h2 class="title">Toys for Best Price</h2>
    <div class="shop-content">

      <div class="product-box">
        
        <div class="pic"><img src="images.php/toy1.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy1</h2>
        <span class="product-price">Rs.159</span>
         <div class="add-cart">
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy2.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy2</h2>
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy3.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy3</h2>
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy4.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy4</h2>
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy5.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy5</h2>
       ...
       <div class="product-box">
        <div class="pic"><img src="images.php/toy6.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy6</h2>
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy7.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy7</h2>
        <span class="product-price">Rs.860</span>
        <div class="add-cart">
        <i class="fa-solid fa-cart-shopping"></i>
       </div> 
      </div>
      ...
      <div class="product-box">
        <div class="pic"><img src="images.php/toy8.jpeg" class="product-img"></div>
        <h2 class="product-title">Toy8</h2>
